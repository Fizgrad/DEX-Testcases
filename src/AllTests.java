...
public final class AllTests {
  ...
  private static List<Entry> buildEntries() {
    ...
    list.add(entryWithArgs("Intrinsics", TestKind.SMOKE,
                           IntrinsicsTest::main,
    ...
    list.add(entryWithArgs("GcRootStackMap", TestKind.STRESS,
                           GcRootStackMapTest::main,
                           new String[] {"--short"}, new String[] {"--full"},
                           "GcRootStackMapTest"));
    list.add(entryWithArgs("WriteBarrier", TestKind.STRESS,
                           WriteBarrierStressTest::main,
                           new String[] {"--short"}, new String[] {"--full"},
                           "WriteBarrierStressTest"));
    list.add(entryWithArgs("RegAllocMove", TestKind.STRESS,
                           RegAllocMoveStressTest::main,
                           new String[] {"--short"}, new String[] {"--full"},
                           "RegAllocMoveStressTest"));
    list.add(entryWithArgs("ReferencePhi", TestKind.STRESS,
                           ReferencePhiMergeTest::main,
                           new String[] {"--short"}, new String[] {"--full"},
                           "ReferencePhiMergeTest"));
    list.add(entryWithArgs("StackMapConst", TestKind.STRESS,
                           StackMapConstTest::main,
                           new String[] {"--short"}, new String[] {"--full"},
                           "StackMapConstTest"));
